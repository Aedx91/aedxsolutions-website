    ...
    items: [
      {
        ...
        desc: 'Sitios profesionales, rápidos y multidioma.',
        price: 'Desde $1,500 – $8,000',
        cta: 'Solicita Cotización Gratis',
        href: '/contact',
      },
      {
        tag: 'APIs e Integraciones',
        title: 'APIs e Integraciones Personalizadas',
        desc: 'Conecta tus sistemas: GPS → Fleetio, telefonía → Salesforce, APIs a medida.',
        price: 'Desde $2,500 – $15,000',
        cta: 'Hablemos de Tu Integración',
        href: '/contact',
      },
      {
        tag: 'Sistemas y Automatización',
        title: 'Sistemas Personalizados y Automatización',
        desc: 'Herramientas especializadas: checklists digitales, dashboards y automatización operativa.',
        price: 'Desde $4,000 – $25,000',
